...
ReadOnePad:
    ;Reread to work around a DMC bug (https://www.nesdev.org/wiki/Controller_reading_code#DPCM_Safety_using_Repeated_Reads).
    jsr ReadOnePadTo00
-
    lda $00
    pha
...
ReadOnePadTo00:
    ...
    -
        ...
        lsr
        rol $00                         ;Add button press status to $00.
        bcc -                           ;Loop 8 times to get  status of all 8 buttons.
    rts
...
CheckHealthStatus: ;($CDFA)
    ...
    beq Lx006
        ...
        beq Lx005
            ; play hurt sfx if 
            bpl Lx004
                lda #sfxDMC_HomerHitByChair
                jsr SFX_SetDMCSFXFlag
            Lx004:
