...
InitBrinstarGFX:
    ...
    .byte SurfaceBG_Frame0/$400+1
    .byte SurfaceBG_Frame0/$400+2
    .byte SurfaceBG_Frame0/$400+3
    .byte BlankSPR/$400
...
InitNorfairGFX:
    ...
    .byte HeartBG_Frame0/$400+1
    .byte HeartBG_Frame0/$400+2
    .byte HeartBG_Frame0/$400+3
    .byte BlankSPR/$400
...
InitTourianGFX:
    ...
    .byte SheolBG_Frame0/$400+1
    .byte SheolBG_Frame0/$400+2
    .byte SheolBG_Frame0/$400+3
    .byte BlankSPR/$400
...
InitKraidGFX:
    ...
    .byte TrenchBG_Frame0/$400+1
    .byte TrenchBG_Frame0/$400+2
    .byte TrenchBG_Frame0/$400+3
    .byte BlankSPR/$400
...
InitRidleyGFX:
    ...
    .byte LabyrinthBG_Frame0/$400+1
    .byte LabyrinthBG_Frame0/$400+2
    .byte LabyrinthBG_Frame0/$400+3
    .byte BlankSPR/$400
...
ChooseEnding:
    ldy #$01
    @loop:
        ;If SamusAge+2 anything but #$00, load worst ending(Rat Junko, more than 218 minutes of gameplay).
...
@endingFound:
    ...
    ;Was the best ending achieved? Branch if not (dress stays on)
    lda #$00
    cpy #$05
    bcc @endIf_A
        ;Dress OFF, baby!
